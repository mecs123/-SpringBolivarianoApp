...
public class CourseServiceImpl implements ICourseService {
    ...
    public StudentByCouseResponse findStudentsByCourseId(Long courseId) {
        ...
        StudentByCouseResponse studentByCouseResponse = new StudentByCouseResponse();
        studentByCouseResponse.setCourseName(course.getName());
        studentByCouseResponse.setStudentDTOList(studentDTOList);
        return studentByCouseResponse;
    }
}
